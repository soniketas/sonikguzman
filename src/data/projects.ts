...
export const projects: Project[] = [
	...
	},
	{
		...
		process:
			"I structured the site around four clear stops: home, about (the company's 15-year history and its real accolades), services (the installation broken into three concrete steps: reception & analysis, water study, installation), and contact, built in WordPress with Elementor and the Astra theme. The approach prioritized simplicity and accessibility: built to WCAG 2.1 AA guidelines, with careful color contrast, straightforward keyboard navigation, descriptive alt text on every image, and a clear semantic structure for screen readers — validated by a 98/100 Lighthouse accessibility score. On top of that foundation, the 'free water audit' request form stayed one click away on every page.",
		result:
